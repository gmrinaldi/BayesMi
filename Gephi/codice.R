...
# Rete per Gephi (visualizzazione effetto modifiche)

rete<-modified_flows%>%rename(Source=id_inizio,Target=id_fine)
...
write.gexf(nodes = geonodes,edges = geoedges[,1:2],edgesWeight = geoedges$relchange,edgesAtt = geoedges[,4:6],
           nodesAtt = geonodes_attr,defaultedgetype="directed",output="C:/Users/nb2/Desktop/Politecnico/StatBayes/BayesMi/Gephi/rete_modificata.gexf")
